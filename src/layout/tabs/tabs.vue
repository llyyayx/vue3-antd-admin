<template>
  <a-tabs v-model:activeKey="activeKey" type="editable-card" :tab-bar-gutter="6" hide-add class="tabs__view"
    @tabClick="jump" @edit="deltab">
    <a-tab-pane v-for="(item, index) in tabsStore.tabList" :key="item.fullPath">
      <template #tab>
